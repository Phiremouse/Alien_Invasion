...
class AlienInvasion:
    ...
    def __init__(self):
        """
           Initialize the game, create game resources,and establish settings for the main surface.
        """
        pygame.init()
    ...
    def _create_fleet(self):
        ...
        # This alien is not used for anything other than determining space.
        alien = Alien(self)
    ...
    def _create_alien(self, alien_number, row_number):
        ...
        Args:
            alien_number (int): itterator from main loop to determine placement in row.
            row_number (int): itterator from the main loop for rows.
        """
        # Create an alien and place it in the row.
        alien = Alien(self)
        alien_width, alien_height = alien.rect.size
        # Shifts it to the left by alien width then adds 2*alien_width*for loop itterator
        # for each instance of the alien ship.
